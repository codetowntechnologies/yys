...
exports.MultiBarOverlay = ({ params }) => {
    const { data, extrasVisible, iconSize, overlayRadius, setExtrasVisible } = React.useContext(context_1.MultiBarContext);
    ...
    React.useEffect(() => {
        ...
        const animation = react_native_1.Animated.parallel(animationsList);
        animation.start();
